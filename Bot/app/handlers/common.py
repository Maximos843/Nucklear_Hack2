...
get_date_prompt = '''
Выдай из строки "{}" дату в формате год-месяц-день.
Метаинформация = Сегодняшняя дата: {}.
Примеры:
...
get_date_gap_prompt = '''
Из строки "{}" ниже тебе необходимо понять на сколько дней идёт сдвиг относительно текущего врмени в днях
